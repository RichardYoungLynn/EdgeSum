 ...
 ********************************************************************************************/
extern "C" JNIEXPORT void JNICALL
Java_com_example_edgesum_page_objectdetection_NanoDet_init(JNIEnv *env, jclass, jobject assetManager, jboolean useGPU) {
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_example_edgesum_page_objectdetection_NanoDet_detect(JNIEnv *env, jclass, jobject image, jdouble threshold, jdouble nms_threshold) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_edgesum_page_objectdetection_SimplePose_init(JNIEnv *env, jclass clazz, jobject assetManager, jboolean useGPU) {
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_example_edgesum_page_objectdetection_SimplePose_detect(JNIEnv *env, jclass clazz, jobject image) {
    auto result = SimplePose::detector->detect(env, image);

    auto box_cls = env->FindClass("com/example/edgesum/page/objectdetection/KeyPoint");
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_edgesum_page_objectdetection_Yolact_init(JNIEnv *env, jclass clazz, jobject assetManager, jboolean useGPU) {
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_example_edgesum_page_objectdetection_Yolact_detect(JNIEnv *env, jclass clazz, jobject image) {
    auto result = Yolact::detector->detect_yolact(env, image);

    auto yolact_mask = env->FindClass("com/example/edgesum/page/objectdetection/YolactMask");
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_edgesum_page_objectdetection_ocr_ChineseOCRLite_init(JNIEnv *env, jclass clazz, jobject assetManager, jboolean useGPU) {
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_example_edgesum_page_objectdetection_ocr_ChineseOCRLite_detect(JNIEnv *env, jclass clazz, jobject bitmap, jint short_size) {
...
//    LOGD("jni ocr ocrresult[0][0]:%s", ocrResult[0].pre_res[0].c_str());
    ...
    auto ocr_result = env->FindClass("com/example/edgesum/page/objectdetection/ocr/OCRResult");
 ...
 ********************************************************************************************/
extern "C" JNIEXPORT void JNICALL
Java_com_example_edgesum_page_objectdetection_ENet_init(JNIEnv *env, jclass, jobject assetManager, jboolean useGPU) {
...
Java_com_example_edgesum_page_objectdetection_ENet_detect(JNIEnv *env, jclass, jobject image) {
 ...
 ********************************************************************************************/
extern "C" JNIEXPORT void JNICALL
Java_com_example_edgesum_page_objectdetection_MbnSeg_init(JNIEnv *env, jclass, jobject assetManager, jboolean useGPU) {
...
extern "C" JNIEXPORT jfloatArray JNICALL
Java_com_example_edgesum_page_objectdetection_MbnSeg_detect(JNIEnv *env, jclass, jobject image) {
 ...
 ********************************************************************************************/
extern "C" JNIEXPORT void JNICALL
Java_com_example_edgesum_page_objectdetection_MbnFCN_init(JNIEnv *env, jclass, jobject assetManager, jboolean useGPU) {
...
extern "C" JNIEXPORT jfloatArray JNICALL
Java_com_example_edgesum_page_objectdetection_MbnFCN_detect(JNIEnv *env, jclass, jobject image) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_edgesum_page_objectdetection_FaceLandmark_init(JNIEnv *env, jclass clazz, jobject assetManager, jboolean useGPU) {
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_example_edgesum_page_objectdetection_FaceLandmark_detect(JNIEnv *env, jclass clazz, jobject image) {
    auto result = FaceLandmark::detector->detect(env, image);

    auto box_cls = env->FindClass("com/example/edgesum/page/objectdetection/FaceKeyPoint");
 ...
 ********************************************************************************************/
extern "C" JNIEXPORT void JNICALL
Java_com_example_edgesum_page_objectdetection_DBFace_init(JNIEnv *env, jclass clazz, jobject assetManager, jboolean useGPU) {
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_example_edgesum_page_objectdetection_DBFace_detect(JNIEnv *env, jclass clazz, jobject image, jdouble threshold, jdouble nms_threshold) {
